...
export function initTopNav() {
    ...
    slot.innerHTML = `
        <div class="pointer-events-auto w-full max-w-[1200px] bg-[#121212] border border-gray-800 shadow-md rounded-2xl px-4 py-3 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-3 text-gray-400">
                <button class="w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-800 transition-colors active:scale-95">
        ...
        <div class="pointer-events-auto w-full max-w-[1200px] bg-cardbg/90 backdrop-blur-xl border border-gray-700/50 shadow-[0_10px_30px_rgba(0,0,0,0.5)] rounded-2xl relative">
            ...
            <div id="device-dropdown-menu" class="hidden absolute top-[110%] left-0 w-full bg-[#1a1a1a] border border-gray-700 shadow-2xl rounded-2xl p-3 z-[250] flex-col space-y-2">
                ${Object.values(allDevices).map(dev => `
                    <div class="bg-[#121212] border border-gray-800 rounded-xl p-3 flex justify-between items-center ${dev.hwid === activeDevice.hwid ? 'border-aqua/50 bg-aqua/5' : ''}">
                        <div class="flex items-center space-x-3">
